...
public class ComercioEletronico {
    ...
    public static void cadastrarProduto(String tipoDeProduto, int codigo, String nome, String descricao, LocalDate dataFabricacao, double valor, String nomeFabricante, boolean disponivel) {
        produtos.add(factoryProduto(tipoDeProduto, codigo, nome, descricao, dataFabricacao, valor, Controller.ControladorFabricante.getFabricanteString(nomeFabricante), disponivel));
